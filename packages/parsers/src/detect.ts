 ...
 */
export async function detectAndParseRoutes(
    rootDir: string,
    options?: ParserOptions,
    ...
    const [nextAppRoutes, nextPagesRoutes, trpcRoutes, nestRoutes] =
        await Promise.all([
            detected.nextApp
